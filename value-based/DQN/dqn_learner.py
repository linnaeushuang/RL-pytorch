...
class agent():
    ...
    def update(self):
        ...
        # return the Q value of the selected action from transition
        # example of method gather(dim,index):
        # actions is the vertor of index selected action
        # [[0],[1],[0]]
        # [[state1],    net     [[q1,q2],                                 [[q1],
        #  [state2], --------->  [q1,q2], .gather(dim=1,index=actions) --> [q2],
        #  [state3]]             [q1,q2]]                                  [q1]]
    ...
    def train(self,num_episode):
        ...
        for i in range(num_episode):
            ...
            scores.append(np.sum(r_batch))
            del r_batch[:]
        return scores

    def parallel_train(self,seedlist,num_episode):
        ...
        for seed in seedlist:
            ...
            scores.append(self.train(num_episode))
        return scores
...
if __name__ =='__main__':
    ...
    #sc=train_agent.train(100)
    #print(sc)

    scoreslist=np.array(train_agent.parallel_train(np.random.randint(100,200,size=10),20))
    print(scoreslist.mean(axis=0))
    print(scoreslist.std(axis=0))
